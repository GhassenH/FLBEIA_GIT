...
#  interactions between métiers // perfect observation
###############################################################################
...
run_flbeia <- function (q_m1, q_m2) {
  ...
  fleets$IRE@metiers$TR1@catches$COD@catch.q <- fleets$IRE@metiers$TR1@catches$COD@catch.q * q_m1
  fleets$IRE@metiers$TR1@catches$HAD@catch.q <- fleets$IRE@metiers$TR1@catches$HAD@catch.q * q_m1
  fleets$IRE@metiers$TR1@catches$WHG@catch.q <- fleets$IRE@metiers$TR1@catches$WHG@catch.q * q_m1
  fleets$IRE@metiers$TR2@catches$COD@catch.q <- fleets$IRE@metiers$TR2@catches$COD@catch.q * q_m2
  fleets$IRE@metiers$TR2@catches$HAD@catch.q <- fleets$IRE@metiers$TR2@catches$HAD@catch.q * q_m2
  fleets$IRE@metiers$TR2@catches$WHG@catch.q <- fleets$IRE@metiers$TR2@catches$WHG@catch.q * q_m2
  
  fleets$UK@metiers$TR1@catches$COD@catch.q <- fleets$UK@metiers$TR1@catches$COD@catch.q * q_m1
  fleets$UK@metiers$TR1@catches$HAD@catch.q <- fleets$UK@metiers$TR1@catches$HAD@catch.q * q_m1
  fleets$UK@metiers$TR1@catches$WHG@catch.q <- fleets$UK@metiers$TR1@catches$WHG@catch.q * q_m1
  fleets$UK@metiers$TR2@catches$COD@catch.q <- fleets$UK@metiers$TR2@catches$COD@catch.q * q_m2
  fleets$UK@metiers$TR2@catches$HAD@catch.q <- fleets$UK@metiers$TR2@catches$HAD@catch.q * q_m2
  fleets$UK@metiers$TR2@catches$WHG@catch.q <- fleets$UK@metiers$TR2@catches$WHG@catch.q * q_m2
  
  fleets$FRA@metiers$TR1@catches$COD@catch.q <- fleets$FRA@metiers$TR1@catches$COD@catch.q * q_m1
  fleets$FRA@metiers$TR1@catches$HAD@catch.q <- fleets$FRA@metiers$TR1@catches$HAD@catch.q * q_m1
  fleets$FRA@metiers$TR1@catches$WHG@catch.q <- fleets$FRA@metiers$TR1@catches$WHG@catch.q * q_m1
  fleets$FRA@metiers$TR2@catches$COD@catch.q <- fleets$FRA@metiers$TR2@catches$COD@catch.q * q_m2
  fleets$FRA@metiers$TR2@catches$HAD@catch.q <- fleets$FRA@metiers$TR2@catches$HAD@catch.q * q_m2
  fleets$FRA@metiers$TR2@catches$WHG@catch.q <- fleets$FRA@metiers$TR2@catches$WHG@catch.q * q_m2
  
  fleets$OTH@metiers$TR1@catches$COD@catch.q <- fleets$OTH@metiers$TR1@catches$COD@catch.q * q_m1
  fleets$OTH@metiers$TR1@catches$HAD@catch.q <- fleets$OTH@metiers$TR1@catches$HAD@catch.q * q_m1
  fleets$OTH@metiers$TR1@catches$WHG@catch.q <- fleets$OTH@metiers$TR1@catches$WHG@catch.q * q_m1
  fleets$OTH@metiers$TR2@catches$COD@catch.q <- fleets$OTH@metiers$TR2@catches$COD@catch.q * q_m2
  fleets$OTH@metiers$TR2@catches$HAD@catch.q <- fleets$OTH@metiers$TR2@catches$HAD@catch.q * q_m2
  fleets$OTH@metiers$TR2@catches$WHG@catch.q <- fleets$OTH@metiers$TR2@catches$WHG@catch.q * q_m2
  ...
  effort.restr.IRE <- "min" 
  effort.restr.UK  <- "min"  
  effort.restr.FRA <- "min" 
  effort.restr.OTH <- "min" 
  ...
  # population
  stkObs.models <- rep("perfectObs", 3)
  ...
  ####################################################
  ##### 2.3 Management advice component : advice ##### 
  ####################################################
  ...
  #########################################################
  ##### 2.4 Management advice component : advice.ctrl ##### 
  #########################################################
  ...
  multIREs <- FLBEIA(biols = multiBio,       # FLBiols object with 2 FLBiol element for COD.
                     ...
                     # BDs = multiBD,        # A list with 1 FLBDSim object for HAD.
  ...
  # return(multiRes)
  if (isTRUE(class(multIREs) == "list")) {return(multIREs)} else {return("error")}
}
